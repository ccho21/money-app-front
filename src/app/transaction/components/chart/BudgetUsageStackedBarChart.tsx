...
const chartData = [
  { category: 'Food', used: 120000, budget: 100000 },
  { category: 'Transport', used: 80000, budget: 100000 },
  { category: 'Shopping', used: 60000, budget: 60000 },
];
...
const overCount = chartData.filter((d) => d.used > d.budget).length;

export function BudgetUsageStackedBarChart() {
